...
import { getRejected, getApplication } from '../../services/insuranceService';
...
const RejectedPatients = () => {
  ...
  const load = async () => {
    ...
    try {
      ...
      const addrs = await getRejected(page * PAGE_SIZE, PAGE_SIZE);
      ...
      setError(e?.message || 'Failed to load rejected patients');
    ...
    <DashboardLayout userRole="insurance" userProfile={{}} walletAddress={walletAddress} networkStatus={networkStatus}>
      <div className="space-y-6">
        <div className="bg-white rounded-lg shadow p-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div className="text-lg font-semibold">View Rejected Patients</div>
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="px-4 py-3 border-b">Rejected</div>
